...
router.post('/generate', async (req, res) => {
  try {
    const { icons, fontName = 'PixoraFont', startUnicode = 0xe000 } = req.body;
    ...
    const css = `/* ${fontName} — Generated by Pixora — World's Largest Free Icon Library */
...
<title>${fontName} — Pixora Icon Font</title>
<style>
@font-face {
  font-family: '${fontName}';
...
<header>
  ...
  <div class="meta">
    <div>Generated by <strong>Pixora</strong> — World's Largest Free Icon Library</div>
...
<footer><p>Made with ♥ by <a href="https://pixora.app">Pixora</a> · Fonts embedded — no internet needed</p></footer>
...
function cp(t,b){navigator.clipboard.writeText(t).then(()=>{const o=b.textContent;b.textContent='✓ copied';b.style.cssText='background:#f0fdf4;border-color:#bbf7d0;color:#166534';setTimeout(()=>{b.textContent=o;b.style.cssText=''},1500);});}
    ...
    const manifest = {
      ...
      generator: 'Pixora — World\'s Largest Free Icon Library',
    ...
    const readme = `# ${fontName} — Icon Font by Pixora
