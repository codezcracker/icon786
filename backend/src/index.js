...
app.listen(PORT, () => {
  ...
  if (aiKey) {
    console.log('🤖 AI: Icon786 Free enabled (server API key loaded)\n');
  } else {
    console.log('🤖 AI: No server key — search uses basic fallback; generate needs a key in AI settings or backend/.env\n');
  }
