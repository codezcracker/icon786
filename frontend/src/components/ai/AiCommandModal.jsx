...
import { hasAiCredentials } from '../../utils/aiApiConfig';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (tab === 'search') {
        ...
        if (!hasAiCredentials(apiConfig, serverAiEnabled)) {
          setError('AI generate needs an API key. Open AI settings and add your key (required for local dev).');
          openApiConfig();
          setLoading(false);
          return;
        }
